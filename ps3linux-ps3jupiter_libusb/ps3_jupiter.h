...
struct ps3_jupiter_event_listener {
	struct ps3_jupiter_event_listener *prev;
	struct ps3_jupiter_event_listener *next;

	void (*callback)(struct ps3_jupiter_event_listener *self, struct ps3_eurus_event *event);
};
